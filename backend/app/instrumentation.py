...
Observability and instrumentation setup.
Initializes LangWatch tracing and provides a structured event logger
for workflow audit trails.
"""
...
logger = logging.getLogger("notebooklm.events")
